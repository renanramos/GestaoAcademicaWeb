...
<body>
<div class="container">
<h3><legend><a href="home">Cursos Cadastrados</a></legend></h3>
</div>
...
<!-- 	<h4><a href="form" class="label label-success">&nbsp;Novo</a></h4><i class="glyphicon glyphicon-plus-sign"></i> -->
	<a href="form_cursos"><button class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;Novo</button></a>
</div>
<div class="col-mod-4"></div>
</div>
</body>
